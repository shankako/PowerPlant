        ...
        implements DataIngestionServiceAPI
{
    ...
    @Override
    @RequestMapping(value = "/getLastFiveMinutesData", method = RequestMethod.GET)
	public @ResponseBody String getLastFiveMinutesData(
			 @RequestHeader(value = "authorization", required = false) String authorization,
			 @RequestParam("countryId") String countryId) {
    	 {
    		 this.dataIngestionHandler.getLastFiveMinutesData(authorization,countryId);
    	    }
    		return this.dataIngestionHandler.getLastFiveMinutesData(authorization, countryId);
    }
