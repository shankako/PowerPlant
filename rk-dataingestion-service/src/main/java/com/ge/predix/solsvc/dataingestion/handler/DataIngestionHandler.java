...
public class DataIngestionHandler
{
    ...
    {
        this.timeSeriesDataIngestionHandler.getLastFiveMinutesData(authorization,countryId);
        return  this.timeSeriesDataIngestionHandler.getLastFiveMinutesData(authorization,countryId);
    }
    ...
    {
        Asset asset = this.assetDataHandler.retrieveAsset(null, "id", "/country/IND",
                null);
        ObjectMapper mapper = new ObjectMapper();
        StringWriter writer = new StringWriter();
        try
