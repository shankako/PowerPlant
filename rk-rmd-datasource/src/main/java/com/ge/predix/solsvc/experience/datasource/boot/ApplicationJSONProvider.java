 ...
 * Data and Filter.  For example, if the Rest API has an Animal class and the client passes 
 * Cat, Dog, or Goat, the register subtypes method will register the proper mapping.
 * 
 * In this example, a DMDataSeq extends DMDataEvent extends DataEvent extends Data.  Yet, the API allows any kind of Data.
 ...
 * 
 * By adding the "complexType":"DMDataSeq" pair to object, this is all that is needed to know what type of Data the Provider 
 * should unmarshal to.
 * 
 * the complexType annotation can be automatically placed in the JSON simply by placing this annotation on the Parent class Data.
