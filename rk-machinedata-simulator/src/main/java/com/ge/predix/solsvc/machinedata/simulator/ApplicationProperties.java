...
{
    @Value("${dataingestion.service.url:#{null}}")
	...
	public String getDiServiceURL() {
		return diServiceURL;
	}

	public void setDiServiceURL(String diServiceURL) {
		this.diServiceURL = diServiceURL;
	}
