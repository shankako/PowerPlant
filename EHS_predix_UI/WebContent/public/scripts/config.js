...
'use strict';
/**
 * This file sets up the basic module libraries you'll need for your
 * application.
 */
...
require.config({
	...
	paths : {
		...
		'c3-angular' : '../bower_components/c3/c3-angular.min',

	},
	priority : [ 'jquery', 'angular', 'angular-resource', 'angular-route' ],
	shim : {
		'angular' : {
			deps : [ 'jquery' ],
			exports : 'angular'
